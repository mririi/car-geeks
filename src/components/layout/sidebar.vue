    ...
    <div class="sidebar-wrapper sidebar-theme">
        <nav ref="menu" id="sidebar">
            ...
            <perfect-scrollbar class="list-unstyled menu-categories" tag="ul" :options="{ wheelSpeed: 0.5, swipeEasing: !0, minScrollbarLength: 40, maxScrollbarLength: 300, suppressScrollX: true }">
               <li class="menu">
                <a href="/questions" class="dropdown-toggle" @click.native="toggleMobileMenu">
               ...
               <li class="menu">
                <a href="/services" class="dropdown-toggle" @click.native="toggleMobileMenu">
                    <a class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                <a href="/entreprises" class="dropdown-toggle" @click.native="toggleMobileMenu">
                    <a class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                <a href="/groups" class="dropdown-toggle" @click.native="toggleMobileMenu">
                    <a class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                <a href="/news" class="dropdown-toggle" @click.native="toggleMobileMenu">
                    <a class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                <a href="/contact-us" class="dropdown-toggle" @click.native="toggleMobileMenu">
                    <a class="dropdown-toggle">
