<template>
    <!--  BEGIN SIDEBAR  -->
    <div id="app" class="sidebar-wrapper sidebar-theme ">
        <nav ref="menu" id="sidebar">
         <div class="shadow-bottom"></div>
            <perfect-scrollbar class="list-unstyled menu-categories" tag="ul" :options="{ wheelSpeed: 0.5, swipeEasing: !0, minScrollbarLength: 40, maxScrollbarLength: 300, suppressScrollX: true }">
               ...
               <li class="menu">
                <router-link  v-slot="{ navigate }" :to="{ path:'/questions'}" class="" @click.native="toggleMobileMenu">
                    <a class="dropdown-toggle">
                        <div class="">
                            ...
                            <span @click="navigate" >{{ $t('Questions') }}</span>
                        </div>
                    </a>
                </router-link>
               </li>
               <li class="menu">
                <router-link custom v-slot="{ navigate }" :to="{ path:'/services'}" class="menu" @click.native="toggleMobileMenu">
                    <a class="dropdown-toggle">
                        <div class="">
                            ...
                            <span @click="navigate" >{{ $t('Services') }}</span>
                        </div>
                    </a>
                </router-link>
               </li>
                <li class="menu">
                <router-link custom v-slot="{ navigate }" :to="{ path:'/entreprises'}" class="menu" @click.native="toggleMobileMenu">
                    <a class="dropdown-toggle">
                        <div class="">
                            ...
                            <span @click="navigate"  >{{ $t('Entreprises') }}</span>
                        </div>
                    </a>
                </router-link>
                </li>
                <li class="menu">
                <router-link custom v-slot="{ navigate }" :to="{ path:'/groups'}" class="menu" @click.native="toggleMobileMenu">
                    <a class="dropdown-toggle">
                        <div class="">
                            ...
                            <span @click="navigate" >{{ $t('Groups') }}</span>
                        </div>
                    </a>
                </router-link>
                </li>
                <li class="menu">
                <router-link custom v-slot="{ navigate }" :to="{ path:'/news'}" class="menu" @click.native="toggleMobileMenu">
                    <a class="dropdown-toggle">
                        <div class="">
                            ...
                            <span @click="navigate" >{{ $t('News') }}</span>
                        </div>
                    </a>
                </router-link>
                </li>
                <li class="menu">
                <router-link custom v-slot="{ navigate }" :to="{ path:'/contact-us'}" class="menu" @click.native="toggleMobileMenu">
                    <a class="dropdown-toggle">
                        ...
                        <div class="">
                           <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 1536 1536"><path fill="currentColor" d="M515 783v128H263V783h252zm0-255v127H263V528h252zm758 511v128H932v-128h341zm0-256v128H601V783h672zm0-255v127H601V528h672zm135 860V148q0-8-6-14t-14-6h-32L978 384L768 213L558 384L180 128h-32q-8 0-14 6t-6 14v1240q0 8 6 14t14 6h1240q8 0 14-6t6-14zM553 278l185-150H332zm430 0l221-150H798zm553-130v1240q0 62-43 105t-105 43H148q-62 0-105-43T0 1388V148Q0 86 43 43T148 0h1240q62 0 105 43t43 105z"/></svg>
                            <span @click="navigate" >{{ $t('Contact-us') }}</span>
                        </div>
                    </a>
                </router-link>
                </li>
