                ...
                <div class="col-md-12">
                  <ul class="list-inline badge-collapsed-img mb-0 mb-3">
                    ...
                    <span v-for="m in Members" :key="m.id">
                      <span v-if="m.groupMem==group.id && m.userprofileMem">
...
export default {
  ...
  methods: {
    ...mapActions(['GetGroups', 'GetGroupposts', 'GetUserprofiles', 'GetGroupcomments', 'GetGroupmembers','CreateGroupmember']),
    ...
    Join()
    {
       await this.CreateGroupmember({userprofileMem});
    }
  },
};
</script>
