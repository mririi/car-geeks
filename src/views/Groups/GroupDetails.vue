                ...
                <div class="col-md-12">
                  <ul class="list-inline badge-collapsed-img mb-0 mb-3">
                    <li class="list-inline-item chat-online-usr">
                      <img alt="avatar" src="@/assets/images/profile-2.jpeg" class="ml-0" />
                    </li>
                    <li class="list-inline-item chat-online-usr">
          ...
          <div class="timeline-simple">
            ...
            <div class="timeline-list">
              <span v-for="p in GroupPost" :key="p.id">
                <span v-if="p.groupPost == group.id">
...
export default {
  ...
  methods: {
    ...mapActions(['GetGroups', 'GetGroupposts', 'GetUserprofiles']),
  },
};
</script>
<style scoped>
