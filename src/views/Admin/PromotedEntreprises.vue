          ...
          <div class="page-header">
            <nav class="breadcrumb-one" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Promoted Entreprises</span></li>
              </ol>
            </nav>
          </div>
        </li>
        ...
        <div class="panel p-0">
          <div class="custom-table table3">
            ...
            >
             ...
             <template #cell(datePE)="data">
              <span v-if="data.item.datePE != null">
                {{data.item.datePE}}
              </span>
 ...
 ...mapGetters({
   ...
   filteredList() {
      return this.Entreprisepromotions.filter((entreprise) => {
        return entreprise.nbDays.includes(this.search)&& entreprise.Running==true;
      });
    },
