          ...
          <div class="page-header">
            <nav class="breadcrumb-one" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Verification list</span></li>
              </ol>
            </nav>
          </div>
        </li>
        ...
        <div class="panel p-0">
          <div class="custom-table table3">
            ...
            <template #cell(imageVerif)="data">
              ...
              <b-avatar :src="data.item.imageVerif" v-b-modal="modimage(data.item.id)" size="4rem" rounded="lg"  alt="" srcset=""/>
 ...
 ...mapGetters({
     ...
     filteredList() {
      return this.Userprofiles.filter((profile) => {
        return (profile.firstname.toLowerCase().includes(this.search.toLowerCase())||
               profile.lastname.toLowerCase().includes(this.search.toLowerCase()))&& profile.verified==true;
      });
    },
  ...
  methods: {
    ...
    bind_data() {
      ...
      this.columns2 = [
        ...
        { key: 'imageVerif', label: 'Verification'},
