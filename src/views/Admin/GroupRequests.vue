      ...
      <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
        <div class="panel p-0">
          <div class="custom-table table3">
            ...
            <template #cell(userprofileG)="data">
                <span v-for="u in Userprofiles" :key="u.id">
                    <span v-if="u.id == data.item.userprofileG">
             ...
             <template #cell(imageG)="data">
              ...
              <b-avatar :src="'http://127.0.0.1:8000'+data.item.imageG" size="4rem" rounded="lg"  alt="" srcset=""/>
                  </router-link>
              </span>
              <span v-else>
 ...
 ...mapGetters({
     ...
     filteredList() {
      return this.Groups.filter((group) => {
        return group.titleG.toLowerCase().includes(this.search.toLowerCase())&& group.accepted ==false;
      });
    },
  ...
  methods: {
    ...
    bind_data() {
      ...
      this.table_option2.total_rows = this.Groups.length;
      this.get_meta2();
    },
