          ...
          <div class="page-header">
            <nav class="breadcrumb-one" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Verification requests</span></li>
              </ol>
            </nav>
          </div>
        </li>
          ...
          <div class="custom-table table3">
            ...
            >
             <template #cell(status)="data">
              ...
              <span v-else>
               <b-badge variant="danger">UnVerified</b-badge>
              </span>
            </template>
            ...
            <template #cell(actions)="data">
             ...
             <template #cell(imageVerif)="data">
              ...
              <b-avatar v-b-modal="modimage(data.item.id)" :src="data.item.imageVerif" size="4rem" rounded="lg"  alt="" srcset=""/>
...
export default {
  metaInfo: { title: 'User service Verification Requests' },
  data() {
    return {
 ...
 ...mapGetters({
     ...
     filteredList() {
      return this.Userprofiles.filter((profile) => {
        return profile.verified==false && profile.imageVerif!=null;
      });
    },
  ...
  methods: {
    ...
    Delete(id) {
      this.$swal({
        ...
        if (result.value) {
            axios.put('/userprofile/userprofile-update/' + id + '/', {
              imageVerif: null,
            });
          
          this.$swal('Deleted!', 'The Request has been deleted.', 'success');
          this.$router.go();
        }
      });
    },
    ...
    bind_data() {
      //table 3
      this.columns2 = [
        { key: 'imageU', label: 'Image' },
        { key: 'firstname', label: 'First Name'},
        { key: 'lastname', label: 'Last Name' },
        { key: 'imageVerif', label: 'Verification Image'},
