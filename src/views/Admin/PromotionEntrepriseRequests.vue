          ...
          <div class="page-header">
            <nav class="breadcrumb-one" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Promoted Entreprises Requests</span></li>
              </ol>
            </nav>
          </div>
        </li>
      ...
      <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
        <div class="panel p-0">
          <div class="custom-table table3">
            ...
            >
               <template #cell(entreprisePE)="data">
              <span v-for="e in Userentreprises" :key="e.id">
                <span v-if="e.id == data.item.entreprisePE">
             ...
             <template #cell(Running)="data">
              ...
              <span @click="Accept(data.item.id,data.item.entreprisePE)">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
...
export default {
  metaInfo: { title: 'Promotion Entreprise Requests' },
  data() {
    return {
      //table 3
      items2: [],
  ...
  computed: {
    ...
    filteredList() {
      return this.Entreprisepromotions.filter((entreprise) => {
        return entreprise.nbDays.includes(this.search)&& entreprise.Running==false;
      });
    },
  },
  methods: {
    ...
    bind_data() {
      //table 3
      this.columns2 = [
        { key: 'entreprisePE', label: 'Entreprise' },
