          ...
          <div class="page-header">
            <nav class="breadcrumb-one" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Services List</span></li>
              </ol>
            </nav>
          </div>
        </li>
            ...
            <template #cell(userprofileS)="data">
             ...
             <template #cell(typeS)="data">
              <span v-for="t in Servicetypes" :key="t.id">
                <span v-if="t.id == data.item.typeS">
               ...
               <template #cell(imageS)="data">
                <span v-if="data.item.imageS!=null">
                   <router-link :to="'/servicedetails/'+data.item.id">
              <b-avatar :src="data.item.imageS" size="4rem" rounded="lg"  alt="" srcset=""/>
                   </router-link>
              </span>
              <span v-else>
