                ...
                <b-tab title="Right" active>
                  <div v-for="rep in Replies" :key="rep.id">
                    <div v-if="rep.questionRep == question.id && rep.accepted == true && rep.checked==true" class="panel-body notation-text-icon">
                      <!--repmodif-->
                      <b-modal :id="'modalModifReplyRight' + rep.id" hide-footer title="Modify Answer" title-tag="h4" modal-class="register-modal" footer-class="justify-content-center">
                        <form class="mt-0">
                          <div class="form-group">
                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="24" height="24" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                              <path
                      ...
                      <b-media>
                        ...
                        >
                          <b-dropdown variant="icon-only" dropleft toggle-tag="a" class="mb-4 mr-2 custom-dropdown float-right">
                            ...
                            <b-dropdown-item v-b-modal="modalModifReplyRight(rep.id)">Modify</b-dropdown-item>
...
export default {
  ...
  methods: {
    ...
    modalModifReplyRight(id) {
      return 'modalModifReplyRight' + id;
    },
  },
  created() {
    this.GetQuestions();
