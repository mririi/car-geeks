    ...
    <div class="col-xl-12 mt-3 col-lg-6 col-md-12 col-sm-12 col-12 layout-spacing">
      <div class="widget widget-card-one">
        ...
        <div class="widget-content">
          <b-card class="bg-transparent border-0 col-12">
            <b-card-text>
              <h6 class="ml-5 mb-5">{{ question.contentQ }}</h6></b-card-text
            ></b-card
          >
          ...
          <div class="w-action">
            <div class="card-like ml-4">
              ...
              <span v-else-if="existentreprise == true">
                <svg @click="showAlertlike()" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="24" height="24" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512">
                  <path
                    fill="currentColor"
                    d="M96 191.1H32c-17.67 0-32 14.33-32 31.1v223.1c0 17.67 14.33 31.1 32 31.1h64c17.67 0 32-14.33 32-31.1V223.1c0-16.8-14.3-32-32-32zM512 227c0-36.89-30.05-66.92-66.97-66.92h-99.86C354.7 135.1 360 113.5 360 100.8c0-33.8-26.2-68.78-70.06-68.78c-46.61 0-59.36 32.44-69.61 58.5c-31.66 80.5-60.33 66.39-60.33 93.47c0 12.84 10.36 23.99 24.02 23.99a23.88 23.88 0 0 0 14.97-5.26c76.76-61.37 57.97-122.7 90.95-122.7c16.08 0 22.06 12.75 22.06 20.79c0 7.404-7.594 39.55-25.55 71.59a23.934 23.934 0 0 0-3.066 11.72c0 13.92 11.43 23.1 24 23.1h137.6C455.5 208.1 464 216.6 464 227c0 9.809-7.766 18.03-17.67 18.71c-12.66.86-22.36 11.4-22.36 23.94c0 15.47 11.39 15.95 11.39 28.91c0 25.37-35.03 12.34-35.03 42.15c0 11.22 6.392 13.03 6.392 22.25c0 22.66-29.77 13.76-29.77 40.64c0 4.515 1.11 5.961 1.11 9.456c0 10.45-8.516 18.95-18.97 18.95h-52.53c-25.62 0-51.02-8.466-71.5-23.81l-36.66-27.51a23.851 23.851 0 0 0-14.38-4.811c-13.85 0-24.03 11.38-24.03 24.04c0 7.287 3.312 14.42 9.596 19.13l36.67 27.52C235 468.1 270.6 480 306.6 480h52.53c35.33 0 64.36-27.49 66.8-62.2c17.77-12.23 28.83-32.51 28.83-54.83a65.97 65.97 0 0 0-.64-9.122c17.84-12.15 29.28-32.58 29.28-55.28a66.33 66.33 0 0 0-1.876-15.64C499.9 270.1 512 250.2 512 227z"
                  />
            ...
            <b-modal id="exampleModalCenter" hide-footer title="Add Answer" title-tag="h4" modal-class="register-modal" footer-class="justify-content-center">
              <form class="mt-0">
                <div class="form-group">
                  ...
                  <b-form-textarea
                    type="text"
                    v-model="replies.contentR"
                    class="mb-2"
                    :class="[is_submit_reply ? (replies.contentR && replies.contentR.length < 500 && replies.contentR.length > 25 ? 'is-valid' : 'is-invalid') : '']"
          ...
          <div class="float-right mt-4">
            <b-button-group>
              ...
              <a class="btn btn-outline-primary" href="#">Most Liked</a>
            </b-button-group>
          </div>
                      ...
                      <b-modal :id="'modalModifReplyMost' + rep.id" hide-footer title="Modify Answer" title-tag="h4" modal-class="register-modal" footer-class="justify-content-center">
                        <form class="mt-0">
                          <div class="form-group">
                            ...
                            <b-form-textarea
                              type="text"
                              v-model="rep.contentR"
                              class="mb-2"
                              :class="[is_submit_replymodif ? (rep.contentR && rep.contentR.length < 500 && rep.contentR.length > 25 ? 'is-valid' : 'is-invalid') : '']"
                              placeholder="Enter your reply content here"
                            ></b-form-textarea>
                            <b-form-valid-feedback>Looks good!</b-form-valid-feedback>
                          ...
                          <b-button variant="primary" block class="mt-2 mb-2" @click="replyModif(rep)">Submit</b-button>
                        </form>
                      </b-modal>
                      <b-media>
                              ...
                              <b-card-text v-else-if="rep.checked == true && question.userprofileQ == CurrentUserProfile.id">
                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="3em" height="3em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                                  <path
                                    fill="#62b47d"
                                    fill-rule="evenodd"
                                    d="M2 15.5V2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.74.439L8 13.069l-5.26 2.87A.5.5 0 0 1 2 15.5zm8.854-9.646a.5.5 0 0 0-.708-.708L7.5 7.793L6.354 6.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3z"
                                  />
                                </svg>
                              </b-card-text>
                              <b-card-text>
                        ...
                        <div class="media-notation mb-4 float-right">
                          ...
                          <a v-else-if="existentreprise == true">
                            <svg
                              @click="showAlertlike()"
                              xmlns="http://www.w3.org/2000/svg"
                              aria-hidden="true"
                            ...
                            <form class="mt-0">
                              <div class="form-group">
                                ...
                                <b-form-textarea
                                  type="text"
                                  class="mb-2"
                                  v-model="comment.contentCo"
                                  :class="[is_submit_comment ? (comment.contentCo && comment.contentCo.length < 200 && comment.contentCo.length > 15 ? 'is-valid' : 'is-invalid') : '']"
                              ...
                              <b-button variant="primary" block class="mt-2 mb-2" @click="commentaire(rep)">Submit</b-button>
                            </form>
                          </b-modal>
                        </div>
                      </b-media>
                                ...
                                <form class="mt-0">
                                  <div class="form-group">
                                    ...
                                    <b-form-textarea
                                      type="text"
                                      class="mb-2"
                                      :class="[is_submit_commentmodif ? (c.contentCo && c.contentCo.length < 200 && c.contentCo.length > 15 ? 'is-valid' : 'is-invalid') : '']"
                                      v-model="c.contentCo"
  ...
  methods: {
    ...
    async replyModif(r) {
      try {
        ...
        if (this.replies.contentR && this.replies.contentR.length < 500 && this.replies.contentR.length > 25) {
          this.$bvModal.hide('modalModifReplyMost' + r.id);
          var formdata = new FormData();
          if (this.image != null) {
            formdata.append('imageR', this.image);
          }
    ...
    async commentaire(rep) {
      ...
      if (this.comment.contentCo && this.comment.contentCo.length < 200 && this.comment.contentCo.length > 15) {
        this.$bvModal.hide('modalCreateCommentMost' + rep.id);
    ...
    async commentModif(c) {
      try {
        ...
        if (this.comment.contentCo && this.comment.contentCo.length < 200 && this.comment.contentCo.length > 15) {
          this.$bvModal.hide('modalModifCommentMost' + c.id);
