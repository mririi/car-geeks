...
=======
    <div class="row layout-top-spacing">
      <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
        <div class="panel br-4">
          <div class="panel-body">
            <form-wizard title="" @on-complete="onComplete" subtitle="" class="circle" error-color="#e74c3c" color="#4361ee">
              <h4 class="text-center mt-2 mb-3">More Informations</h4>
              <tab-content title="" icon="far fa-user">
                <b-form novalidate>
                  <b-form-row class="mb-4">
                  ...
                  <b-form-row class="mb-4">
                    ...
                    <b-form-group label="Phone Number" class="col-md-6">
                      <MazPhoneNumberInput primary v-model="form.tel" />
                    </b-form-group>
                  </b-form-row>
                  <hr />
                  <b-form-row class="mb-4">
                  ...
                  <b-form-row class="mb-4">
                    <div class="custom-file-container" data-upload-id="myFirstImage">
                      <label>Insert your image<a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image">x</a></label>
>>>>>>> 3b1a0e5e136b4eee041aa8af042de7a8ce4bd87c
