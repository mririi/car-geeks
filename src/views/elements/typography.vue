        ...
        <div class="container">
            <div class="nav sidenav">
                <scrollactive class="sidenav-content" tag="div" active-class="active" :offset="120" :modifyUrl="false" :highlightFirstItem="true">
                    <a href="#typographyHeading" class="nav-link scrollactive-item">Heading</a>
                    <a href="#typographyInline-elements" class="nav-link scrollactive-item">Inline Elements</a>
                    <a href="#typographyLists" class="nav-link scrollactive-item">Lists</a>
                    <a href="#typographyBlockquotes" class="nav-link scrollactive-item">Blockquotes</a>
                </scrollactive>
            </div>
                            ...
                            <div class="font-family-showcase">
                                ...
                                <div class="font-family-info">
                                    ...
                                    <div class="font-family-link">
                                        <b-button tag="a" target="_blank" variant="primary" href="https://fonts.google.com/?query=Nunito&selection.family=Nunito:400,600,700">View Family</b-button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <b-media>
                                            <template #aside>
                                                <div class="usr-img mr-2">
                                                    <img class="br-30" src="@/assets/images/profile-16.jpeg" alt="avatar" />
                                                </div>
                                            </template>
