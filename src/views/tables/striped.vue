                    ...
                    <div class="custom-table">
                        ...
                        <div class="table-footer">
                            ...
                            <div class="paginating-container pagination-solid flex-column align-items-right">
                                ...
                                <!--<b-pagination v-model="table_option.current_page" :total-rows="table_option.total_rows" :per-page="table_option.page_size" prev-class="prev" next-class="next" first-number last-number>
                                    <template #prev-text>
...
<script>
    export default {
        metaInfo: { title: 'Bootstrap Striped Table' },
        data() {
            return {
                items: [],
                columns: [],
