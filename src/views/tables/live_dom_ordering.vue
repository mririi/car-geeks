                    ...
                    <div class="custom-table">
                        ...
                        <b-table ref="basic_table" responsive :items="items" :fields="columns" :per-page="table_option.page_size" :current-page="table_option.current_page" :filter="table_option.search_text"
                            ...
                            <template #cell(age)="row">
                                <b-input type="number" v-model="row.item.age" size="sm"></b-input>
                            </template>
                            <template #cell(position)="row">
                                <b-input v-model="row.item.position" size="sm"></b-input>
                            </template>
                            <template #cell(office)="row">
                                <b-select v-model="row.item.office" size="sm" :options="office_list"></b-select>
                            </template>
                        </b-table>
...
<script>    
    export default {
        metaInfo: { title: 'Bootstrap Live Dom Ordering Table' },
        data() {
            return {
                items: [], columns: [],
        ...
        methods: {
            bind_data() {
                ...
                this.office_list = [...new Map(this.items.map(item => [item.office, item])).values()].map(d => { return d.office });
            },
