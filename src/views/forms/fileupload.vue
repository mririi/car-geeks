        ...
        <div class="container">
            <div class="nav sidenav">
                <scrollactive class="sidenav-content" tag="div" active-class="active" :offset="120" :modifyUrl="false" :highlightFirstItem="true">
                    <a href="#fuSingleFile" class="nav-link scrollactive-item">Single File</a>
                    <a href="#fuMultipleFile" class="nav-link scrollactive-item">Multiple File</a>
                </scrollactive>
            </div>
            ...
            <div class="row layout-top-spacing">
                <div class="col-12">
                    <div class="alert alert-arrow-left alert-icon-left alert-light-info mb-0 text-break">
                        ...
                        Documentation: <a target="_blank" href="https://www.npmjs.com/package/file-upload-with-preview" class="text-info">
