        ...
        <div class="container">
            <div class="nav sidenav">
                <scrollactive class="sidenav-content" tag="div" active-class="active" :offset="120" :modifyUrl="false" :highlightFirstItem="true">
                    <a href="#wizards_pills" class="nav-link scrollactive-item">Pills</a>
                    <a href="#wizards_circle" class="nav-link scrollactive-item">Circle</a>
                    <a href="#wizards_square" class="nav-link scrollactive-item">Square</a>
                </scrollactive>
            </div>
            <div class="row layout-top-spacing">
                <div class="col-12">
                    <div class="alert alert-arrow-left alert-icon-left alert-light-info mb-0 text-break">
                        ...
                        Documentation:
                        <a target="_blank" href="https://www.npmjs.com/package/vue-form-wizard" class="text-info">
