        ...
        <div class="container">
            <div class="nav sidenav">
                <scrollactive class="sidenav-content" tag="div" active-class="active" :offset="120" :modifyUrl="false" :highlightFirstItem="true">
                    <a href="#basic" class="nav-link scrollactive-item">Basic</a>
                    <a href="#autosaving" class="nav-link scrollactive-item">Autosaving</a>
                </scrollactive>
            </div>
            <div class="row layout-top-spacing">
                <div class="col-12">
                    <div class="alert alert-arrow-left alert-icon-left alert-light-info mb-0 text-break">
                        ...
                        Documentation: <a target="_blank" href="https://www.npmjs.com/package/vue-easymde" class="text-info">
                            https://www.npmjs.com/package/vue-easymde
                        </a>
                    </div>
                </div>
            </div>
...
<style>
    .vue-easymde .editor-toolbar { border: 1px solid #ddd; border-radius: 6px; opacity: 1; }
    .vue-easymde .CodeMirror { margin-top: 28px; border-radius: 6px; }
    .vue-easymde .editor-toolbar button { color: #4361ee !important; }
    .vue-easymde .editor-toolbar button.active, .vue-easymde .editor-toolbar button:hover { border-color: #4361ee !important; opacity: 0.6; }
    .vue-easymde .CodeMirror-fullscreen, .vue-easymde .editor-preview-side { z-index: 9999 !important; margin-top: 0 !important; }
</style>
<script>
    ...
    export default {
        metaInfo: { title: 'Markdown Editor' },
        components: {
            highlight,
            VueEasymde
        },
