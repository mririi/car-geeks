        ...
        <div class="container">
            <div class="nav sidenav">
                <scrollactive class="sidenav-content" tag="div" active-class="active" :offset="120" :modifyUrl="false" :highlightFirstItem="true">
                    <a href="#fs2Basic" class="nav-link scrollactive-item">Baic</a>
                    <a href="#fs2Nested" class="nav-link scrollactive-item">Nested</a>
                    <a href="#fs2DisablingOptions" class="nav-link scrollactive-item">Disabling Options</a>
                    <a href="#fs2Placeholder" class="nav-link scrollactive-item">Placeholder</a>
                    <a href="#fs2Tagging" class="nav-link scrollactive-item">Tagging</a>
                    <a href="#fs2LimitTagging" class="nav-link scrollactive-item">Limit Tagging</a>
                </scrollactive>
            </div>
            <div class="row layout-top-spacing">
                <div class="col-12">
                    <div class="alert alert-arrow-left alert-icon-left alert-light-info mb-0 text-break">
                        ...
                        Documentation: <a target="_blank" href="https://www.npmjs.com/package/vue-multiselect" class="text-info">
...
<style>
    .select2 .multiselect__option--highlight { background: #fff; color: #4361ee; }
    .select2 .multiselect__option--selected { background-color: rgba(27, 85, 226, 0.23921568627450981); color: #4361ee; font-weight: normal; }
    .select2 .multiselect__option--disabled { background: inherit !important; }
    .select2 .multiselect__tag { color: #000; background: #e4e4e4; }
    .select2 .multiselect__tag-icon:after { color: #000 !important; }
    .select2 .multiselect__tag-icon:focus, .select2 .multiselect__tag-icon:hover { background: inherit; }
</style>
<script>
    ...
    export default {
        metaInfo: { title: 'Vue Multiselect' },
        components: {
            highlight,
            Multiselect
        },
        data() {
            return {
                ...
                options3: [{ name: 'orange' }, { name: 'white', $isDisabled: true }, { name: 'purple' }],
                value: { name: 'orange' },
                options4: ['orange', 'white', 'purple'],
                options5: ['orange', 'white', 'purple'],
            }
        },
        mounted() {
        },
        methods: {
            ...
            addTag(newTag) {
                this.options4.push(newTag)
                this.inputs['input4'].push(newTag)
            },
            addTag1(newTag) {
                this.options5.push(newTag)
                this.inputs['input5'].push(newTag)
            }
        }
    };
</script>
