          ...
          <div class="page-header">
            <nav class="breadcrumb-one" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Join Request</span></li>
              </ol>
            </nav>
          </div>
        </li>
...
export default {
     ...
     this.group = response.data;
      ...
      for (let up in this.Userentreprises) {
        for (i in this.pendingmember)
          if (this.Userentreprises[up].id == this.pendingmember[i].userentrepriseMem) {
            this.pendingUserentreprises.push(this.Userentreprises[up]);
            i++;
          }
      } 
      console.log(this.pendingUserentreprises)
  ...
  computed: {
    ...mapGetters({
     ...
     filteredList() {
      return this.pendingUserentreprises.filter((entreprise) => {
        return (
  ...
  methods: {
    ...
    bind_data() {
      ...
      this.columns2 =[
        ...
        { key: 'contactE', label: 'Contact' },
        { key: 'accepted', label: 'Status', class: 'text-center  ' },
        { key: 'actions', label: 'Actions', class: 'text-center  ' },
      ],

      this.table_option2.total_rows = this.pendingUserentreprises.length;
      this.get_meta2();
    },
