        ...
        <div class="container">
            ...
            <div class="nav sidenav">
                <scrollactive class="sidenav-content" tag="div" active-class="active" :offset="120" :modifyUrl="false" :highlightFirstItem="true">
                    <a href="#font-icon_feather" class="nav-link scrollactive-item">Feather</a>
                    <a href="#font-icon_fontawesome" class="nav-link scrollactive-item">Font Awesome</a>
                </scrollactive>
            </div>
